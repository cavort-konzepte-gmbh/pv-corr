...
import { 
  X, Edit3, Eye, Image as ImageIcon, FileText, Video, Save, 
  UploadCloud, Trash2, Check, Filter, SortAsc, SortDesc, Search
} from "lucide-react";
...
const MediaDialog: React.FC<MediaDialogProps> = ({ isOpen, onClose, entityId, currentTheme, entityType }) => {
  ...
  const handleUpdateMedia = async (media: MediaItem, newTitle: string, newDescription: string) => {
    try {
      ...
      // Update local state
      setMediaData(mediaData.map(item => 
        item.url === media.url 
            ...
            <div className="flex flex-col gap-2 mb-4">
              ...
              <Tabs defaultValue="all" onValueChange={(value) => setActiveFilter(value as MediaFilter)}>
                <TabsList className="w-full">
                  ...
                  <TabsTrigger value="photo" className="flex-1">Photos</TabsTrigger>
                ...
                <>
                  ...
                  <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t">
                    ...
                    <Button 
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => handleDeleteMedia(selectedMedia.url)}
                    >
