...
const DashboardLayout = () => {
  ...
  const [settingsView, setSettingsView] = useState<'general' | 'theme' | 'places' | 'people' | 'companies' | 'datapoints'>('general');
        ...
        <div className="flex-1 flex items-center gap-6">
          {view === 'settings' ? (
            <>
              ...
              <button
                onClick={() => setSettingsView('places')}
                className="flex items-center gap-2 px-3 py-2 rounded transition-colors"
                style={{
                  backgroundColor: settingsView === 'places' ? currentTheme.colors.background : 'transparent',
                  color: settingsView === 'places' ? currentTheme.colors.text.primary : currentTheme.colors.text.secondary
                }}
              >
                <span>Places</span>
              </button>
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 rounded transition-colors"
                style={{
                  backgroundColor: settingsView === 'projects' ? currentTheme.colors.background : 'transparent',
                  color: settingsView === 'projects' ? currentTheme.colors.text.primary : currentTheme.colors.text.secondary
                }}
              >
                <span>Projects</span>
              </button>
