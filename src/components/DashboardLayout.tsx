    ...
    <div className="min-h-screen flex flex-col bg-theme">
      ...
      <div className="h-14 border-b flex items-center px-4 border-theme bg-surface">
        <div className="flex-1 flex items-center gap-6">
          {view === 'settings' ? (
            ...
            <>
              ...
              <ButtonSection view={view} match="analyze" onClick={() => setView('analyze')}>
                <Database size={18} />
                <span>Analysis</span>
              </ButtonSection>
        ...
        <div className="flex items-center gap-4">
          {view !== 'settings' && (
            <ButtonSection view={view} match="settings" onClick={() => setView('settings')}>
              <SettingsIcon size={18} />
              <span>Settings</span>
            </ButtonSection>
          )}
          {isAdmin && (
            <ButtonSection view={view} match="administration" onClick={toggleViewMode}>
              <LayoutDashboard size={18} />
              <span>Administration</span>
            </ButtonSection>
          )}
          <ButtonSection view={view} match="signout" onClick={handleSignOut}>
            <LogOut size={18} />
            <span>Sign Out</span>
          </ButtonSection>
        </div>
