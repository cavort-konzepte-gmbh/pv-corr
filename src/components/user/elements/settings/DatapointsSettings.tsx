  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-lg text-primary">Parameters</h3>
        <Button className="px-3 py-1 rounded text-sm flex items-center gap-2 text-white bg-accent-primary">
          <Plus size={14} />
          Add Parameter
        </Button>
      </div>
          ...
          <TableBody>
            {parameters.map((param) => (
              <TableRow key={param.id}>
                <TableCell className="p-2 border border-theme">{param.name}</TableCell>
                <TableCell className="p-2 border border-theme">{param.shortName || "-"}</TableCell>
                <TableCell className="p-2 border border-theme">{param.unit || "-"}</TableCell>
                <TableCell className="p-2 border border-theme">{param.rangeType}</TableCell>
                <TableCell className="p-2 border border-theme">
                  <div className="flex items-center justify-center gap-2">
                    <Button className="p-1 rounded hover:bg-opacity-80 text-secondary">
                      <Edit2 size={14} />
                    </Button>
                    <Button className="p-1 rounded hover:bg-opacity-80 text-secondary">
                      <X size={14} />
