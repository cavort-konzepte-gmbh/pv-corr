    ...
    <div className="p-6 max-w-[210mm] mx-auto bg-theme">
      ...
      <div className="mb-8 p-6 rounded-lg border border-theme bg-surface">
        <div className="flex justify-between items-start mb-6">
          <div>
            <h1 className="text-2xl font-bold text-primary mb-2">{t("analysis.report_title")}</h1>
      ...
      <div className="mb-8 p-6 rounded-lg border border-theme bg-surface">
        <h2 className="text-lg font-medium text-primary mb-4">{t("analysis.methodology")}</h2>
      ...
      <div className="mb-8">
        <h2 className="text-lg font-medium text-primary mb-4">{t("analysis.parameters_results")}</h2>
            ...
            <TableBody>
              {zone.datapoints?.[0]?.values &&
                Object.entries(zone.datapoints[0].values).map(([key, value]) => {
                  ...
                  return (
                    <TableRow key={key}>
                      <TableCell className="p-2 border border-theme">{parameter.parameterCode}</TableCell>
                      <TableCell className="p-2 border border-theme">{value}</TableCell>
                      <TableCell className="p-2 border border-theme">{parameter.unit || "-"}</TableCell>
      ...
      {/* Analysis Results */}
      <div className="mb-8 p-6 rounded-lg border border-theme bg-surface">
        <h2 className="text-lg font-medium text-primary mb-4">{t("analysis.final_results")}</h2>
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="text-sm font-medium text-secondary mb-2">{t("analysis.recommendations")}</div>
            <div className="text-primary">{t("analysis.recommendations_text")}</div>
          </div>
        </div>
      </div>
