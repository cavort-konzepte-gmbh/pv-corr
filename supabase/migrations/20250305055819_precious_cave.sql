/*
  ...
  1. Changes
    - Add proper rating ranges for each parameter
    - Update parameter configurations
    - Ensure correct rating calculation logic

  2. Parameters
    - Update all Z1-Z10 parameters with correct rating ranges
*/

-- First update the parameters with correct rating ranges
UPDATE parameters
...
WHERE id = 'f47c0645-f9d4-4ca0-9eb1-a8cbf38d037e'; -- Z2
...
WHERE id = '0ee3b071-107a-416b-9e38-126cf82fd4a4'; -- Z3
...
WHERE id = '59b28cae-4551-4705-9005-c0206b4bdedb'; -- Z4
...
WHERE id = '41ebeb27-78b8-4b9c-92cb-9a9edd93b3ef'; -- Z5
...
WHERE id = '5ee86cc9-ad68-44ef-a14a-b7df6eff4d31'; -- Z7
...
WHERE id = 'a2b99f8d-83f6-4c3d-855b-c9b90c367aba'; -- Z8
...
WHERE id = '01a85a80-76f1-470a-be59-6b4f70a01aec'; -- Z9
...
WHERE id = 'f303faf2-98c1-4e7c-a130-36b50872cf41'; -- Z10
