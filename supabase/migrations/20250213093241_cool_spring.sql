/*
  # Remove type from substructure_systems table
  
  1. Changes
    - Remove type column from substructure_systems table
    - Drop type enum since it's only used in substructures table now
